    ...
    <div className="min-h-screen bg-[#f5f5f7]">
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-6 lg:py-8 flex gap-8">
        ...
        <article className="flex-1 min-w-0">
          {/* Breadcrumb */}
          <div className="flex items-center gap-1.5 text-sm text-[rgba(0,0,0,0.48)] mb-5 overflow-x-auto">
          ...
          <div
            className="prose prose-lg max-w-none
              ...
              prose-h2:text-xl sm:prose-h2:text-2xl prose-h2:border-b prose-h2:pb-3 prose-h2:border-[#d2d2d7] prose-h2:font-bold
              prose-h3:text-lg prose-h3:font-semibold
              prose-p:text-[rgba(0,0,0,0.8)] prose-p:leading-relaxed
              prose-a:text-[#0066cc] prose-a:no-underline hover:prose-a:underline prose-a:font-medium
              prose-table:text-sm
              prose-strong:text-[#1d1d1f]
              prose-code:bg-[#f5f5f7] prose-code:text-[#1d1d1f] prose-code:px-1.5 prose-code:rounded prose-code:text-sm prose-code:border-none
              ...
              prose-li:my-0.5 prose-li:text-[rgba(0,0,0,0.8)]"
